...
sudo apt update
echo "deb http://deb.debian.org/debian bullseye-backports main contrib non-free" >> sources.list 
echo "deb https://fasttrack.debian.net/debian-fasttrack/ bullseye-fasttrack main contrib" >> sources.list
echo "deb https://fasttrack.debian.net/debian-fasttrack/ bullseye-backports-staging main contrib" >> sources.list
