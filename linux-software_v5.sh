...
if [[ $distro -eq 1 && $option -eq 1 ]]
then
	echo apt ---  firefox-esr-l10n-en-gb thunderbird-l10n-en-gb chromium vlc clamtk libreoffice-l10n-en-gb  keepassxc menulibre tlp syncthing-gtk nemo gnome-software lollypop obs gufw blender gimp freecad steam lutris cura obs aisleriot-solitaire steam lmms bleachbit distrobox dolphin-emu drawing
...
function Scripts ()
{
    dialog --checklist "checklist" 15 10 10 "photo gimp"  1 "off"  "firefox js, custom luncher,extensions" 2 "off" "virtualbox" 3 "off" "vs codium" 4 "off" 
} 
Scripts
